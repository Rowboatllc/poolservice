    ...
    <div class="form-box">
        ...
        <div class="tab-content">
            ...
            <div id="sectionC" class="tab-pane fade">
                ...
                <div class="row sectionC2 divLoadData">
                    <div class="select-data col-sm-4">select-data</div>
                    <div class="logo-data col-sm-4">logo-data</div>
                    <div class="address-data col-sm-4">address-data</div>
                </div>
            </div>
